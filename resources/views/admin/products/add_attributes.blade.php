...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="{{ url('/admin/view-products') }}">Products</a> <a href="{{ url('/admin/add-product') }}" class="current">Add Product Attributes</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-attributes/'.$productDetails->id) }}" name="add_attributes" id="add_attributes" novalidate="novalidate">{{ csrf_field() }}
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <label><strong>{{ $productDetails->product_color }}</strong></label>
                </div>
              </div>
              <div class="control-group">
