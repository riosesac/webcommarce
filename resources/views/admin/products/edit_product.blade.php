...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/admin/dashboard') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Dashboard</a> <a href="{{ url('/admin/view-products') }}">Products</a> <a href="{{ url('/admin/edit-product') }}" class="current">Edit Product</a> </div>
    <h1>Edit Product</h1>
